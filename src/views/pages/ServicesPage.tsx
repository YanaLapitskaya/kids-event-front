    ...
    render() {
        ...
        return(
            <BasePage>
                ...
                <div {...styles}>
                    <div className="col-lg-3 col-md-4 col-sm-6 col-xs-12 service">
                        <div className="hovereffect">
                            <img className="img-responsive" src={process.env.PUBLIC_URL + '/images/Elza.jpg'} alt="elza"/>
                            <div className="overlay">
                                <h2>Спасем Эльзу</h2>
                                <div className="hidden text">
                                    Не обычная сказка-квест "Спасем Эльзу!" на день рождение вашего ребенка с виар-очками, баланс-бордом и капелькой волшебства. 
                                    ...
                                    Можем приехать на ваш день рождения с чудесной сказкой ☺
                                </div>
                                <RaisedButton 
                                    className="hidden"
                                    {...orderBtn}
                                    // onClick={() => this.handleOpen(s)}
                                >
                                    Заказать
                                </RaisedButton>
                            </div>
                    ...
                    <div className="col-lg-3 col-md-4 col-sm-6 col-xs-12 service">
                        <div className="hovereffect">
                            ...
                            <div className="overlay">
                                <h2>Литл поняшки</h2>
                                <div className="hidden text">
                                    Прямиком из Понивилль наши разноцветные Литл поняшки готовы прилететь к вашим детям на праздник и устроить для вас концерт со своей кавер-группой, 
                                    провести незабываемую вечеринку, зарядить энергией и хорошим настроением надолго. 
                                    Волшебством обязательно будет пропитан весь праздник.Необычные игры и секретные испытания должны удивить не только детей, 
                                    но и всех гостей. Всем захочется прокатиться на радуге, прикаснуться к Вошебству и зарядиться эмоциями радости и счастья.
                                </div>
                                <RaisedButton 
                                    className="hidden"
                                    {...orderBtn}
                    ...
                    <div className="col-lg-3 col-md-4 col-sm-6 col-xs-12 service">
                        <div className="hovereffect">
                            ...
                            <div className="overlay">
                                ...
                                <div className="hidden text">
                                    "Пижамная вечеринка" Говорят, если совместить пледы, мягкие подушки и теплую пижамку с нашими веселыми девчонками-аниматорами, 
                                    то получится пижамная хюгге-вечеринка 🎉 Дресс-код (пижамный) обязателен-для настроения, гаджеты с камерами приветствуются, 
                                    так как мастер-класс по фото и соц.сетям разрешает в этот вечер злоупотреблять телефоном. 
                                    Сладости в постеле - обязательно. Караоке и Танцы - будут, гадать научимся, подарочные дневники с милыми пони заведем и мейк с мастерством причёсок освоим. 
                                    Ну и конечно, веселые конкурсы! А главное, посвящение принцесс в королев сна!
                                </div>
                                <RaisedButton 
                                    className="hidden"
                                    {...orderBtn}
