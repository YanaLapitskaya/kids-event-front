                        ...
                        <div className="hovereffect">
                            ...
                            <div className="overlay">
                                ...
                                <div className="hidden text">
                                    ...
                                    <p className="price">Цена: 65 бел. р.</p>
                                </div>
                                {/* <RaisedButton 
                                    className="hidden"
                                    {...orderBtn}
                        ...
                        <div className="hovereffect">
                            ...
                            <div className="overlay">
                                ...
                                <div className="hidden text">
                                    ...
                                    но и всех гостей. Всем захочется прокатиться на радуге, прикоснуться к Вошебству и зарядиться эмоциями радости и счастья.<br/>
                                    <p className="price">Цена: 65 бел. р.</p>
                                </div>
                                {/* <RaisedButton 
                                    className="hidden"
